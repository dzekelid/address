...
created: "2018-06-25"
modified: "2018-06-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/address/master/_listings/aws-directory-service/apis.md
...
- name: AWS Directory Service API Add Ip Routes
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/address/master/_listings/aws-directory-service/actionaddiproutes-get-openapi.md
- name: AWS Directory Service API List Ip Routes
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/address/master/_listings/aws-directory-service/actionlistiproutes-get-openapi.md
- name: AWS Directory Service API Remove Ip Routes
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/address/master/_listings/aws-directory-service/actionremoveiproutes-get-openapi.md
- name: AWS Directory Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/address/master/_listings/aws-directory-service/openapi.md
x-common:
